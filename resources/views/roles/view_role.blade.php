              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="{{ $role->created_at ? date('m/d/Y', strtotime($role->created_at)) : '' }}" readonly>
                  </div>
                </div>
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="{{ $role->updated_at ? date('m/d/Y', strtotime($role->updated_at)) : '' }}" readonly>
                  </div>
                </div>
              </div>
