...
class AffiliationSheet implements FromCollection, WithTitle,WithHeadings,ShouldAutoSize,WithStyles,WithColumnWidths
{
    use Exportable;
     ...
     public function styles($data)
    {
        ...
        foreach ($this->data as $index => $item) {
            if (isset($item['affiliationtitle'])) {
