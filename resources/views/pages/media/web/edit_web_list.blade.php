        ...
        <table style="width:100%" id="pages-list" class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <img src="{{asset('assets/media/'.$media->light_image)}}" alt="image" class="view_image" data-image="{{asset('assets/media/'.$media->light_image)}}">
              </td>
              <td>{{$media->image_width.' x '.$media->image_height}}</td>

              <td>
                <!-- <a href="javascript:void(0)"  title="View"><i class="text-info fa fa-eye"></i></a> -->
                <a href="{{ route('media.website.edit', ['id' =>base64_encode($media->id)]) }}" title="Edit"><i class="text-warning fa fa-edit"></i></a>
              </td>
            </tr>
            @empty
            <tr>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Media Website</h5>
