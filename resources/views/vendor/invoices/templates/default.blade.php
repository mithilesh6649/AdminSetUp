...
<html lang="en">
    ...
    <body>
        {{-- Header --}}
        @if($invoice->logo)
            <div class="invoice_logo w-100 text-center">
                <img src="{{ $invoice->getLogo() }}" alt="logo" height="100">
                <h3 class="w-100 logo_tag_line">WhichVocation</h3>
            </div>
        @endif
        <table class="table mt-5">
            <tbody>
                <tr>
                    ...
                    <td class="border-0 pl-0 text-right" width="50%">
                        <table width="100%" class="table_inner" cellpadding = "0" cellspacing = "0">
                            <tr>
                                <td style="padding: 0;"><label class="serial_date">{{ __('invoices::invoice.serial') }}</label></td>
                            </tr>
                            <tr>
                               <td style="padding: 0;"><strong>{{ $invoice->getSerialNumber() }}</strong></td>                                    
                            </tr>
                            <tr>
                                <td style="padding: 0;"><label class="serial_date">{{ __('invoices::invoice.date') }}</label></td>
                            </tr>
                            <tr>
                                <td style="padding: 0;"><strong class="w-100">{{ $invoice->getDate() }}</strong></td>
                            </tr>
                        </table>
                    </td>
                </tr>
        ...
        {{-- Seller - Buyer --}}
        <table class="table seller-buyer" style="background-color:#cccccc;">
            <thead>
                <tr>
        ...
        <table class="table table-bordered mt-5">
            ...
            <tbody>
                ...
                @if($invoice->taxable_amount)
                    <tr>
                        <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
                        <td class="text-center pl-0">{{ __('invoices::invoice.taxable_amount') }}</td>
                        <td class="text-center pr-0">
                ...
                @endif
                    <tr>
                        <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
                        <td class="text-center pl-0">{{ __('invoices::invoice.total_amount') }}</td>
        ...
        @if($invoice->notes)
            <p style="background-color: #e4e5e7; margin-bottom: 0; padding: 15px; font-size: 15px;">
