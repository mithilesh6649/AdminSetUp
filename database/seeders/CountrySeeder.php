...
class CountrySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $counteries = [
            ...
            ["SSD",  "12.862807",         "30.217636",      "South Sudan"],
        ...
        // foreach ($counteries as $key => $value) {
        //     $create = [
        ...
        foreach ($test as $key => $value) {
            if ($value["timezones"][0]) {
                $country_id = Country::where('iso2', $value["iso2"])->update(['timezone' => $value["timezones"][0]["zoneName"]]);
            }
            // $country_id = Country::where('iso2', $value["iso2"])->update(['regions' => $value['region']]);
            echo $value["name"] . " ID=" . $country_id . ":\n";
        }
    }
}
