...
class VerifyUser extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->from(config("adminlte.from_email", 'admin@wantwire.com'), config('adminlte.wantwire', 'Wantwire'))
            ->cc('yamini@rvtechnologies.com')
            ->line('You have successfully registered to Wantwire. Please click the link below to verify your account.')
