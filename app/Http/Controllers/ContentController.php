...
class ContentController extends Controller
{
	...
	{
		if (Auth::user()->can('manage_website_content_action')) {
	...
	public function editWebsitePage($id)
	{
		if (Auth::user()->can('edit_website_content')) {
			...
			$pageSections = DB::table('page_sections')->where('device_type', 'web')->get();
	...
	public function editMobilePage($id)
	{
		...
		$pageContent = Page::find($id);
		$pageSections = DB::table('page_sections')->where('device_type', 'mobile')->get();
	...
	public function viewMobilePage($id)
	{
		...
		$pageContent = Page::find($id);
		//return $pageContent;
		$section = DB::table('page_sections')->where('slug', $pageContent->section)->where('device_type', 'mobile')->first();
		//return $section;
		$addedBy = Admin::find($pageContent->added_by_id);
		$updatedBy = Admin::find($pageContent->updated_by_id);
